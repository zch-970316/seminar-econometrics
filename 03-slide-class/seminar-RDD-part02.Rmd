...
### [4.群组分析(Cluster observations)](#cluster)
...
## Code script: Hensen bruce fig 19-5
...
```{r, eval=TRUE}
source("../Rscript/hensen21-fig19-5.R", encoding = "UTF-8")
```
...
## Code script: Hensen bruce fig 19-6
...
```{r, eval=TRUE}
source("../Rscript/hensen21-fig19-6.R", encoding = "UTF-8")
```
...
（5）进一步计算**逐点置信区间**（Pointwise Conﬁdence Interval）（见前面附表），并得到置信带（见后面附图）。
...
<div class="my-footer"><span>huhuaping@  &emsp;&emsp; <a href="#chapter-RDD">  </a>
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
<a href="#cluster"> 4.群组分析(Cluster observations) </a> </span></div> 
